...
# ─── Detection & Inference ──────────────────────────────────────────
DEFAULT_CONFIDENCE_THRESHOLD = float(os.getenv("CONFIDENCE_THRESHOLD", "0.35"))
VERIFICATION_THRESHOLD = float(os.getenv("VERIFICATION_THRESHOLD", "0.70"))
...
STRICT_EXCLUDE_CLASSES = set(range(0, 15)) | set(range(24, 80))
